...
public class S2BuilderUtil {
  ...
  static class IndexMatchingLayer implements S2BuilderLayer {
    ...
    public IndexMatchingLayer(
        GraphOptions graphOptions, S2ShapeIndex index, int dimension, double tolerance) {
      this.graphOptions = new GraphOptions(graphOptions);
    ...
    public IndexMatchingLayer(
        GraphOptions graphOptions, S2ShapeIndex index, int dimension) {
     ...
     */
    public IndexMatchingLayer(GraphOptions graphOptions, S2ShapeIndex index) {
