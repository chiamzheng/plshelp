...
public interface S2LaxPolygonShape extends S2ShapeAspect.EdgeAspect.Closed {
  ...
  static class SimpleArray extends Simple.Array implements S2LaxPolygonShape {
  ...
  static class SimpleList extends Simple implements S2LaxPolygonShape {
  ...
  static class SimplePacked extends Simple.Packed implements S2LaxPolygonShape {
  ...
  static class SimpleSnapped extends Simple.Snapped implements S2LaxPolygonShape {
  ...
  static class MultiArray extends Multi.Array implements S2LaxPolygonShape {
   ...
   */
  static class MultiList extends Multi implements S2LaxPolygonShape {
    private final List<S2Point> vertices;
  ...
  static class MultiPacked extends Multi.Packed implements S2LaxPolygonShape {
  ...
  static class MultiSnapped extends Multi.Snapped implements S2LaxPolygonShape {
