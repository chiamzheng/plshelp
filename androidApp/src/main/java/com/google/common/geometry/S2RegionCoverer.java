 ...
 * operations.
 *
 * <pre>Typical usage: {@code
 *    S2RegionCoverer coverer = S2RegionCoverer.builder().setMaxCells(5).build();
 ...
 *
 * <p>Because it is an approximation algorithm, one should not rely on the stability of the output.
 * In particular, the output of the covering algorithm may change across different versions of the
 * library.
 *
