...
public class S2BuilderGraph {
   ...
   * or empty polygon. See {@link IsFullPolygonPredicate}.
   */
   ...
   *     IsFullPolygonPredicate} for details).
   */
  ...
  public int minInputEdgeId(int edgeId) {
    IdSet idSet = inputEdgeIds(edgeId);
   ...
   * represents the empty polygon or the full polygon. See {@link IsFullPolygonPredicate}
   * for details.
   */
  IsFullPolygonPredicate isFullPolygonPredicate() {
