 ...
 * CellTarget}, and you can find the furthest edges from an arbitrary collection
 * of points, polylines, and polygons by using an {@link ShapeIndexTarget}.
 *
...
public abstract class S2FurthestEdgeQuery<D extends S1Distance<D>> extends S2BestEdgesQueryBase<D> {
  ...
  /**
   * Convenience method to create a new Builder, which extends {@link Builder}
