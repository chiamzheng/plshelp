...
public interface S2LaxPolylineShape extends S2ShapeAspect.EdgeAspect.Open {
  ...
  static class MultiArray extends Multi.Array implements S2LaxPolylineShape {
  ...
  static class MultiPacked extends Multi.Packed implements S2LaxPolylineShape {
  ...
  static class MultiSnapped extends Multi.Snapped implements S2LaxPolylineShape {
